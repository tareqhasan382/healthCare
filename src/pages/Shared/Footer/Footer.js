    ...
    return (
        <div>
                ...
                <div className="mt-5 d-flex d-flex-md-row flex-md-row flex-column justify-content-center align-items-center">
                    ...
                    <div className="mx-5 mb-4 mb-md-0">
                        <div className="d-flex justify-content-center align-items-center">
                            ...
                            <span className="ms-2 fs-5 brand">HealthCare</span>
                        </div>
            ...
            <div className="bg-footer">
                <p className="text-secondary text-center pt-4 pb-3 my-0">All Rights Reserved &copy; <span className="brand">HealthCare</span></p>
            </div>
        </div>
    )
}
