...
const Contact = () => {
    return (
        <div className="bg-semilight contact-container pb-4">
            <div style={{ background:`radial-gradient(transparent, black), url('./images/banner/health.jpg') no-repeat top center fixed`, backgroundSize:'cover', height:"181px", marginBottom: '20px', backgroundBlendMode: 'saturation' }}>
                    <div style={{ background:"rgba(0,0,0,0.77)", height:"100%" }} className="text-center d-flex justify-content-center align-items-center">
                        <div className="w-50 px-4 py-3 text-light"><h1>Contact us a Message</h1></div>
                </div>
            </div>
